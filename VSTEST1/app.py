...
VIDEOS_PATH = os.path.join(BASE_DIR, "mp4videos")
ALPHABET_IMAGES_PATH = os.path.join(BASE_DIR, "alphabetimages")
INDIAN_ALPHABET_IMAGES_PATH = os.path.join(BASE_DIR, "indianalphabetsandnumbers")
